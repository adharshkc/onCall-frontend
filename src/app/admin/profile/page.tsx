...
const Profile = () => {
  // You can add a darkMode state here or get it from context/props
  const darkMode = false; // This can be dynamic based on your theme system
      ...
      <div className="profile-container">
        ...
        <div className={`profile-card ${darkMode ? 'dark' : ''}`}>
          <div className="cover-section">
            ...
            />
            <div className="cover-edit-wrapper">
              <label
                htmlFor="cover"
          ...
          <div className="profile-content">
            ...
            <div className="profile-info">
              <h3 className={`profile-name ${darkMode ? 'dark' : ''}`}>
                Danish Heilium
              </h3>
              <p className={`profile-title ${darkMode ? 'dark' : ''}`}>Ui/Ux Designer</p>
              <div className={`profile-stats ${darkMode ? 'dark' : ''}`}>
                <div className={`stat-item ${darkMode ? 'dark' : ''}`}>
                  <span className={`stat-number ${darkMode ? 'dark' : ''}`}>
                    259
                  </span>
                  <span className={`stat-label ${darkMode ? 'dark' : ''}`}>Posts</span>
                </div>
                <div className={`stat-item ${darkMode ? 'dark' : ''}`}>
                  <span className={`stat-number ${darkMode ? 'dark' : ''}`}>
                    129K
                  </span>
                  <span className={`stat-label ${darkMode ? 'dark' : ''}`}>Followers</span>
                </div>
                <div className={`stat-item ${darkMode ? 'dark' : ''}`}>
                  <span className={`stat-number ${darkMode ? 'dark' : ''}`}>
                    2K
                  </span>
                  <span className={`stat-label ${darkMode ? 'dark' : ''}`}>Following</span>
                </div>
              </div>

              <div className="about-section">
                <h4 className={`about-title ${darkMode ? 'dark' : ''}`}>
                  About Me
                </h4>
                <p className={`about-text ${darkMode ? 'dark' : ''}`}>
              ...
              <div className="social-section">
                <h4 className={`social-title ${darkMode ? 'dark' : ''}`}>
                  Follow me on
                </h4>
                <div className="social-links">
                  <Link
                    href="#"
                    className={`social-link ${darkMode ? 'dark' : ''}`}
